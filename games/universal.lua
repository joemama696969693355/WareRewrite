...
local hash = loadstring(game:HttpGet("https://raw.githubusercontent.com/joemama696969693355/WareRewrite/main/libraries/hash.lua", true))()
--pload('libraries/hash.lua', true, true)
--loadstring(downloadFile('vape/libraries/hash.lua'), 'hash')()
local prediction = loadstring(game:HttpGet("https://raw.githubusercontent.com/joemama696969693355/WareRewrite/main/libraries/prediction.lua", true))()
--pload('libraries/prediction.lua', true, true)
--loadstring(downloadFile('vape/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(game:HttpGet("https://raw.githubusercontent.com/joemama696969693355/WareRewrite/main/libraries/entity.lua", true))()
